...
if __name__ == '__main__':
    ...
    #make_label(root, 5, 5, 600, 1300, text=storelist, background='cyan')

    # root = Tk()
    # frame = Frame(root, width=1300, height=600)
    # frame.grid(row=0, column=0)
    # canvas = Canvas(frame, bg='#FFFFFF', width=1300, height=600, scrollregion=(0, 0, 1400, 700))
    ...
    # canvas.config(xscrollcommand=hbar.set, yscrollcommand=vbar.set)
    # canvas.pack(side=LEFT, expand=True, fill=BOTH)
    # canvas.create_text(10, 10, text=storelist)
    # canvas.xview_moveto(0.500)
    # root.mainloop()
